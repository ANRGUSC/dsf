...
sed 's/schedulerName:.*/schedulerName: random-controller/' /home/anrg/dsf/phase-1/Schedulers/src/crd/test-dag.yml > /tmp/test-dag-random.yml
...
kubectl apply -f /home/anrg/dsf/phase-1/Schedulers/src/heft-controller/test-dag.yml
...
kubectl logs -n kube-system -l app=heft-controller --tail=20 | grep -E "Task.*->|Makespan:" || true
