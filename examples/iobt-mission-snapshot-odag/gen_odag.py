...
def generate(nodes, registry, template_name):
    ...
    for i in range(4):
        ...
        capture_blocks.append(make_task_block(
            name=f"capture-{idx}",
            image=f"{registry}/dsf-iobt-capture:latest",
            deps=[],
        ...
        preprocess_blocks.append(make_task_block(
            ...
            image=f"{registry}/dsf-iobt-preprocess:latest",
            deps=[f"capture-{idx}"],
        ...
        infer_blocks.append(make_task_block(
            name=f"infer-{idx}",
            image=f"{registry}/dsf-iobt-infer:latest",
    ...
    fuse_block = make_task_block(
        name="fuse-tracks",
        image=f"{registry}/dsf-iobt-fuse:latest",
    ...
    report_block = make_task_block(
        ...
        image=f"{registry}/dsf-iobt-report:latest",
        deps=["fuse-tracks"],
        data_size=0,
        runtime=2,
