/**
 * TemplateGraph: static DAG visualization for ODAG and CDAG templates.
 *
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 text-xs" style={{ color: neutral.label() }}>
        {d.templateType === 'cdag' && d.replicas != null && (
          <span>replicas: {d.replicas}</span>
        )}
        {d.templateType === 'odag' && d.runtime != null && (
      ...
      >
        ...
        <div className="text-xs space-y-1.5">
          ...
          {d.templateType === 'cdag' && d.replicas != null && (
            <TipRow label="Replicas" value={String(d.replicas)} />
          )}
...
function TemplateGraphInner({ tasks, type }: TemplateGraphProps) {
  ...
  [tasks, layers, layerGroups, hasDownstream, type])
